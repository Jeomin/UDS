# -*- coding: utf-8 -*-
"""
Created on Thu Nov 24 14:44:16 2022
...
class SWMM_ENV:
    ...
    def __init__(self,params,pal_num):
        '''
    ...
    def reset(self,rain):
        ...
        inp.write_file('./sim_files/'+self.params['orf']+'_rain'+self.pal_num+'.inp')
        self.sim=Simulation('./sim_files/'+self.params['orf']+'_rain'+self.pal_num+'.inp')
        self.sim.start()
